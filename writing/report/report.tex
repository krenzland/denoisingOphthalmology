...
This is realized as the optimization game\todo{Cite original gan paper}
\begin{align}
  \cdots.
\end{align}
...
We use \textsc{adam}\ \todo{cite adam} with an initial learning rate of $1r-4$ for both generator and discriminator.
